...
class CompletedLessonRepository(BaseRepository[CompletedLesson]):
    ...
    def create_completed_lesson(self, db: Session, 
                              user_id: uuid.UUID, 
                              lesson_id: uuid.UUID,
                              course_id: uuid.UUID,
                              score: Optional[float] = None,
                              time_spent: int = 0) -> CompletedLesson:
        """
    ...
    def get_user_completed_lessons(self, db: Session, user_id: uuid.UUID) -> List[CompletedLesson]:
        """
    ...
    def get_course_completed_lessons(self, db: Session, 
                                   user_id: uuid.UUID, 
                                   course_id: uuid.UUID) -> List[CompletedLesson]:
        """
    ...
    def is_lesson_completed(self, db: Session, 
                          user_id: uuid.UUID, 
                          lesson_id: uuid.UUID) -> bool:
        """
    ...
    def get_lesson_completion(self, db: Session, 
                            user_id: uuid.UUID, 
                            lesson_id: uuid.UUID) -> Optional[CompletedLesson]:
        """
    ...
    def update_lesson_score(self, db: Session, 
                          completion_id: uuid.UUID, 
                          score: float) -> Optional[CompletedLesson]:
        """
    ...
    def update_lesson_time_spent(self, db: Session, 
                               completion_id: uuid.UUID, 
                               time_spent: int) -> Optional[CompletedLesson]:
        """
    ...
    def count_completed_lessons(self, db: Session, 
                              user_id: uuid.UUID, 
                              course_id: uuid.UUID) -> int:
        """
