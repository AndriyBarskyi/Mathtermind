...
class UserAnswersRepository(BaseRepository[UserAnswer]):
    ...
    def create_user_answer(
        ...
        user_answer = UserAnswer(
            ...
            answer=answer,
            is_correct=False,  # Default value, will be updated after evaluation
            points_earned=0    # Default value, will be updated after evaluation
        )
        db.add(user_answer)
        db.commit()
    ...
    def update_user_answer(self, db: Session, user_answer_id: uuid.UUID, answer: str = None, 
                        is_correct: bool = None, points_earned: int = None):
        """
