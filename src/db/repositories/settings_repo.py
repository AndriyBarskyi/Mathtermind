...
class SettingsRepository(BaseRepository[Setting]):
    ...
    def create_setting(self, db: Session, key: str, value: str, description: str = None, is_protected: bool = False):
        """
    ...
    def update_setting(self, db: Session, setting_id: uuid.UUID, value: str = None, 
                     description: str = None, is_protected: bool = None):
        """
        Update a setting.
