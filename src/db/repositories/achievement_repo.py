...
class AchievementRepository(BaseRepository[Achievement]):
    ...
    def create_achievement(self, db: Session, 
                         name: str,
                         description: str,
                         ...
                         tier: Optional[str] = None) -> Achievement:
        """
    ...
    def award_achievement(self, db: Session, 
                        user_id: uuid.UUID,
                        achievement_id: uuid.UUID,
                        progress_data: Optional[Dict[str, Any]] = None) -> UserAchievement:
        """
    ...
    def get_user_achievements(self, db: Session, user_id: uuid.UUID) -> List[Dict[str, Any]]:
        """
    ...
    def has_achievement(self, db: Session, 
                      user_id: uuid.UUID, 
                      achievement_id: uuid.UUID) -> bool:
        """
    ...
    def get_recent_achievements(self, db: Session, 
                              user_id: uuid.UUID, 
    ...
    def check_achievement_criteria(self, db: Session, 
                                 user_id: uuid.UUID, 
                                 achievement_id: uuid.UUID,
        ...
        # Simple implementation - check if all criteria keys exist in user_data
        # and if the values meet or exceed the criteria values
