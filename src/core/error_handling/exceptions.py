"""
Mathtermind Exception Classes

This module defines custom exception classes for the Mathtermind application.
These exceptions provide a consistent error handling approach across the application.
"""
...
class MathtermindError(Exception):
    ...
    def __init__(self, message: str = "An error occurred in Mathtermind", 
...
class QueryError(DatabaseError):
    ...
    def __init__(self, message: str = "Database query failed", query: Optional[str] = None, **kwargs):
...
class ValidationError(ServiceError):
    ...
    def __init__(self, message: str = "Validation failed", 
                 field_errors: Optional[Dict[str, List[str]]] = None, **kwargs):
        details = kwargs.get('details', {})
        if field_errors:
...
class DependencyError(ServiceError):
    ...
    def __init__(self, message: str = "Service dependency error", 
                 dependency: Optional[str] = None, **kwargs):
        details = kwargs.get('details', {})
        if dependency:
...
class RenderError(UIError):
    ...
    def __init__(self, message: str = "Failed to render UI component", 
...
class InputError(UIError):
    ...
    def __init__(self, message: str = "Invalid user input", 
...
class ContentError(MathtermindError):
    ...
    def __init__(self, message: str = "Content error", 
...
class SecurityError(MathtermindError):
    ...
    def __init__(self, message: str = "Security operation failed", 
        ...
        # Check if error_code is already in kwargs to avoid conflict
        if 'error_code' not in kwargs:
