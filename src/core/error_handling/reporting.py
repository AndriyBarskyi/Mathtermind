...
This module provides tools for error reporting, including capturing error contexts
and sending error reports to logging systems or external services.
"""
...
class ErrorContext:
    ...
    def __init__(self, error: Exception, additional_data: Optional[Dict[str, Any]] = None):
        """
        ...
        # Capture application state if provided
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        # Add MathtermindError details if available
...
class ErrorReporter:
    ...
    def report(self, error: Exception, additional_data: Optional[Dict[str, Any]] = None) -> None:
        """
        Report an error.
        ...
        # Send to external service if configured (implementation omitted)
        # self._send_to_external_service(context)
    ...
    def _send_to_external_service(self, context: ErrorContext) -> None:
        """
        Send the error report to an external service.
        
        This method can be implemented to send error reports to services like
        Sentry, Rollbar, or a custom error tracking system.
        
        Args:
            context: The error context to send
        """
        # This is a placeholder for future implementation
        pass


# Global instance of ErrorReporter
...
class ErrorReportingContext:
    ...
    def __init__(self, context_name: str, additional_data: Optional[Dict[str, Any]] = None):
        """
