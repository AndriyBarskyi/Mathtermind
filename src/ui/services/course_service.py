        ...
        try:
            ...
            for course_id in course_ids:
                try:
                    ...
                    course = course_repo.get_course(self.db, course_uuid)
                    if course:
    ...
    def get_completed_courses(self) -> List[Course]:
        ...
        try:
            ...
            try:
                ...
                user_progress = progress_repo.get_completed_progress(self.db, user_uuid)
            except Exception as e:
                logger.error(f"Error getting completed progress: {str(e)}")
                return []
