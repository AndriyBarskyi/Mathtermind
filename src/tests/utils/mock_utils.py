"""
Utility functions for mocking repositories and database operations in tests.

This module provides helper functions to create mock repositories and
database operations for testing services without relying on actual database operations.
"""
...
# Type variable for generic repository type
T = TypeVar('T')
...
def create_entity_mock(model_class: Type[T], **kwargs) -> T:
    ...
    """
    # Create a basic instance with an ID if not provided
    if 'id' not in kwargs:
