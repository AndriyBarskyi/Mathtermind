...
def test_validate_code_syntax(cs_tools_service):
    ...
    result = cs_tools_service.validate_code_syntax("console.log('Hello, world!');", "javascript")
    assert result["is_valid"] is True
    assert result["success"] is True
...
def test_validate_code_against_testcases(cs_tools_service):
    ...
    # Code that works for all test cases
    ...
    result = cs_tools_service.validate_code_against_testcases(code, test_cases, "python")
...
def test_tracking_service_integration(cs_tools_service):
    ...
    # Act
    cs_tools_service.validate_code_syntax("print('Hello, world!')", "python", user_id="test_user")
