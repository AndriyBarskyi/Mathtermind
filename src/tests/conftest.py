...
from src.db.models import Base, User, Course, Lesson, Tag
from src.db.models.achievement import Achievement, UserAchievement
from src.db.models.content import Content, TheoryContent, ExerciseContent, AssessmentContent, InteractiveContent
...
def test_math_tool(test_db):
    ...
    """
    # First create the base learning tool
    ...
    # Then create the math tool
    math_tool = MathTool(
        id=learning_tool.id,
        math_tool_type=MathToolType.CALCULATOR,
...
def test_informatics_tool(test_db):
    ...
    # Then create the informatics tool
