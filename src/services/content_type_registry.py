"""
Content Type Registry for Mathtermind.

This module provides a centralized registry for all content types in the system.
"""
...
class ContentTypeInfo:
    ...
    name: str  # Internal name used for identification
    display_name: str  # User-friendly display name
    description: str  # Description of this content type
    model_class: Type[Content]  # The associated model class
    validation_function: Optional[Callable[[Any], List[str]]] = None  # Optional validation function
    allowed_parent_types: List[str] = None  # List of content types that can contain this type
    metadata_schema: Dict[str, Any] = None  # JSON schema for custom metadata
    icon: str = None  # Icon identifier for UI display
...
class ContentTypeRegistry:
    ...
    def _register_default_types(self):
        ...
        self.register_content_type(
            ...
            metadata_schema={
                "type": "object",
                "properties": {
                    "quiz_type": {"type": "string", "enum": ["multiple_choice", "short_answer", "mixed"]}
                }
            },
        ...
        self.register_content_type(
            ...
            metadata_schema={
                "type": "object",
                "properties": {
                    "interaction_type": {"type": "string", "enum": ["simulation", "tool", "game", "visualization"]}
                }
            },
            icon="laptop-code"
        )
        ...
        self.register_content_type(
            ...
            metadata_schema={
                "type": "object",
                "properties": {
                    "resource_type": {"type": "string", "enum": ["link", "pdf", "video", "audio", "other"]}
                }
            },
            icon="link"
        )
    ...
    def unregister_content_type(self, name: str) -> bool:
        ...
        try:
            ...
            # Don't allow unregistering default types
            if name in ["theory", "exercise", "quiz", "assessment", "interactive", "resource"]:
    ...
    def validate_content(self, content: Content) -> List[str]:
        ...
        try:
            ...
            # Type-specific validation if available
    ...
    # Validation functions for default content types
